      ...
      <div className="lg:w-[60%] w-full lg:pl-10 lg:px-[50px]">
        ...
        <div className="md:flex justify-between border-b-2 border-black py-[25px]">
          <div className="md:pr-[20px] md:w-[50%] w-full max-md:pb-10 max-md:border-b-2 border-black">
            <h2 className="text-[32px] md:text-[30px] leading-none  lg:leading-[45px] font-[600] mb-6">
              Digital Design
            </h2>
            <p className="font-[400] lg:font-[500] leading-[25px] lg:leading-[20px] md:leading-[20px] tracking-wide lg:text-[16px] md:text-[20px] text-[22px] text-slate-700">
          ...
          <div className="md:border-l-2 md:w-[50%]  border-black md:pl-[20px] max-md:pt-7">
            <h2 className="text-[32px] md:text-[30px] lg:text-[30px] font-[600] mb-6 leading-none  lg:leading-[45px]">
              Art Direction
            </h2>
            <p className="font-[400] lg:font-[500] leading-[25px] lg:leading-[20px] md:leading-[20px] lg:text-[16px] md:text-[20px] text-[22px] text-slate-700 tracking-wide">
        ...
        <div className="md:flex justify-between py-[25px]">
          <div className="lg:pr-[20px] md:w-[50%] max-md:border-b-2 border-black max-md:pb-10">
            ...
            <p className="font-[400] lg:font-[500] leading-[25px] lg:leading-[20px] md:leading-[20px] lg:text-[16px] md:text-[18px] text-[22px] tracking-wide text-slate-700">
          ...
          <div className="md:border-l-2 md:w-[50%] border-black md:pl-[20px] max-md:pt-7">
            ...
            <p className="font-[400] tracking-wide leading-[25px] lg:font-[500] lg:leading-[20px] md:leading-[20px] lg:text-[16px] md:text-[20px] text-[22px] text-slate-700">
